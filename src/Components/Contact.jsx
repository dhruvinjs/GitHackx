        ...
        <form  method="post">
            <section className="mb-32">
                ...
                <div className="flex flex-wrap">
                    {/* Removed nested form element */}
                    <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                        <div className="mb-3 w-full">
                            <label className="block font-medium mb-[2px] text-teal-700" htmlFor="exampleInput90">
                                Name
                            </label>
                            <input name="name" type="text" className="px-2 py-2 border w-full outline-none rounded-md" onChange={handleInput}  placeholder="Name" />
                        </div>
                        ...
                        <div className="mb-3 w-full">
                            ...
                            <input name="email" type="email" className="px-2 py-2 border w-full outline-none rounded-md"
                                placeholder="Enter your email address" onChange={handleInput}/>
                        </div>
                        ...
                        <div className="mb-3 w-full">
                            ...
                            <textarea name="message" className="px-2 py-2 border rounded-[5px] w-full outline-none" placeholder="Enter your message here"onChange={handleInput}/>
                        </div>
                        ...
                        <br />
                         <button type="submit"
                            className="mb-6 inline-block w-full rounded bg-teal-400 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-teal-500" onClick={goHome}>
                           Home
                        </button>
                    </div>
